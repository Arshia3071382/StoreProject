...
function ProductDet() {
  ...
  const {handleIncreaseProductQty , cardItems} = useShoppingCardContext()
        ...
        <div className="shadow-amber-950 h-auto mt-4 grid grid-cols-1 md:grid-cols-12 rounded-2xl">
          ...
          <div className="bg-stone-200 col-span-2 p-4 flex flex-col items-center">
            <img
              ...
              alt={product.title}
            />
            <Button onClick={() => handleIncreaseProductQty(parseInt(params.id as string))} variant="success" className="mt-2 w-full">
             Add to Basket
            </Button>
          </div>
